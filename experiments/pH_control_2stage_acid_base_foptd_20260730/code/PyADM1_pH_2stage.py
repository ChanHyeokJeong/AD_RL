...
STAGE1_VOLUME_FRACTION = 0.8
STAGE2_VOLUME_FRACTION = 0.2
...
def configure_volume(ctx: dict, volume_fraction: float) -> None:
    ctx["V_liq"] = 3400.0 * volume_fraction
    ctx["V_gas"] = 300.0 * volume_fraction
...
def main() -> None:
    print("START pH control serial 2-reactor")
    ...
    for n, u in enumerate(time_values[1:], start=1):
        ...
        dt = u - t0
        stage2["pH_sp"] = stage2["get_pH_sp"](u)
        control_timer += dt
    ...
    out_stage1 = BASE_DIR / "dynamic_out_stage1_55C.csv"
    out_stage2 = BASE_DIR / "dynamic_out_stage2_35C.csv"
    out_gas = BASE_DIR / "gasflow_2stage_serial.csv"
    out_ctl = BASE_DIR / "acid_base_control_log_2stage_serial.csv"
